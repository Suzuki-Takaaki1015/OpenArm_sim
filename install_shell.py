...
shutil.copyfile(root/'docker/app/oa_doctor.py',target.with_name('oa_doctor.py'))
...
print('Installed: oa, oa-code, oa-ros, oa-scene, oa-logs, oa-doctor. Run: source ~/.bashrc')
