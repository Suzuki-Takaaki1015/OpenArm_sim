...
OpenArm 1.0/2.0共通の103項目を収録。シーンGUIの「YCB オブジェクトライブラリを開く」から検索・座標指定・ランダム配置・削除ができます。マグカップ・平皿・ボウルも含みます。公式スキャン93、修復した近似2、代替形状8。詳細と力学上の制限は [YCB.md](docker/YCB.md) を参照してください。
